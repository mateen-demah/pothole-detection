...
from datapoint_classes import RawDataPoint, ExtractedDataPoint
        ...
        with open(raw_data_dir + session_id + '_sensordata.csv', 'r', encoding='utf-8', newline='') as sensordata_file:
            ...
            for row in sensordata:
                ...
                if len(data_window) < 5: continue
                    ...
                    extracted_data_point = ExtractedDataPoint(data_window).toList()
                    extracted_data.writerow(extracted_data_point)
